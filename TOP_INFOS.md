...
- 📝 summary
  - 介绍了在 jsx 中使用 `{}` 语法来动态插入 js 表达式的写法。
...
- 📝 summary
  ...
  - 通过本节的 demo，强调了一个知识点，由 React.createElement 创建的 react 元素对象是不可变的。
...
- 📝 summary
  - 本节介绍了函数组件是什么，以及函数组件的基本语法，并简单提了一嘴 Hooks。
- ⏰ todos
  - 整理 AI 回复。
