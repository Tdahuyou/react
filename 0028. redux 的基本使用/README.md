# [0028. redux 的基本使用](https://github.com/Tdahuyou/react/tree/main/0028.%20redux%20%E7%9A%84%E5%9F%BA%E6%9C%AC%E4%BD%BF%E7%94%A8/README.md)

<!-- region:toc -->
- [📝 Summary](#-summary)
- [🔗 links](#-links)
- [📒 redux 是什么？](#-redux-是什么)
- [📒 redux 核心概念](#-redux-核心概念)
- [📒 纯函数](#-纯函数)
- [📒 redux 的工具和生态系统](#-redux-的工具和生态系统)
- [📒 本节会用到的一些依赖](#-本节会用到的一些依赖)
- [💻 脱离 react 单独使用 redux 来管理状态数据](#-脱离-react-单独使用-redux-来管理状态数据)
- [💻 redux 的基本使用 - createStore 版](#-redux-的基本使用---createstore-版)
- [💻 redux 的基本使用 - @reduxjs/toolkit 版](#-redux-的基本使用---@reduxjs/toolkit-版)
- [💻 redux 的基本使用 - @reduxjs/toolkit 版（模块化）](#-redux-的基本使用---@reduxjs/toolkit-版模块化)
- [🤖 我想要深入了解有关 redux 的内容，应该问你哪些问题呢？](#🤖-我想要深入了解有关-redux-的内容应该问你哪些问题呢)
  - [基本概念](#基本概念)
  - [高级概念](#高级概念)
  - [最佳实践](#最佳实践)
  - [实际应用](#实际应用)
...
## 💻 redux 的基本使用 - @reduxjs/toolkit 版（模块化）
