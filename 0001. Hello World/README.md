...
- [3. 📒 API 描述](#3--api-描述)
- [4. 💻 demo - 在页面上渲染出 Hello World](#4--demo---在页面上渲染出-hello-world)
- [5. 💻 demo - 熟悉 React.createElement 的参数](#5--demo---熟悉-reactcreateelement-的参数)
- [6. 💻 demo - 使用 JSX 来简写](#6--demo---使用-jsx-来简写)
- [7. 🤔 思考：`React.createElement` 跟 `document.createElement` 是一样的吗？](#7--思考reactcreateelement-跟-documentcreateelement-是一样的吗)
- [8. 🤔 思考：`react` 核心库和 `react-dom` 库之间的关系是？](#8--思考react-核心库和-react-dom-库之间的关系是)
- [9. 🤔 思考：为什么一旦使用了 `JSX` 语法，就必须要引入 `react` 核心库？](#9--思考为什么一旦使用了-jsx-语法就必须要引入-react-核心库)
- [10. 🤔 思考：通过脚手架（比如 vite、umi、create-react-app）来搭建工程 vs. 通过（.html）页面的方式来直接引入 react 相关的库](#10--思考通过脚手架比如-viteumicreate-react-app来搭建工程-vs-通过html页面的方式来直接引入-react-相关的库)
- [11. 🤖 请介绍一下 script 标签身上的 type 属性](#11--请介绍一下-script-标签身上的-type-属性)
  - [11.1. **标准用法**](#111-标准用法)
  - [11.2. **模块**](#112-模块)
  - [11.3. **非 JavaScript 类型**](#113-非-javascript-类型)
  - [11.4. **历史用法**](#114-历史用法)
  - [11.5. **实用考虑**](#115-实用考虑)
- [12. 🤖 请介绍一下 script 标签身上的 crossorigin 属性](#12--请介绍一下-script-标签身上的-crossorigin-属性)
  - [12.1. 值](#121-值)
  - [12.2. 作用](#122-作用)
  - [12.3. 示例](#123-示例)
<!-- endregion:toc -->
...
## 5. 💻 demo - 熟悉 React.createElement 的参数
...
## 7. 🤔 思考：`React.createElement` 跟 `document.createElement` 是一样的吗？
...
## 8. 🤔 思考：`react` 核心库和 `react-dom` 库之间的关系是？
...
## 9. 🤔 思考：为什么一旦使用了 `JSX` 语法，就必须要引入 `react` 核心库？
...
## 10. 🤔 思考：通过脚手架（比如 vite、umi、create-react-app）来搭建工程 vs. 通过（.html）页面的方式来直接引入 react 相关的库
...
## 12. 🤖 请介绍一下 script 标签身上的 crossorigin 属性
