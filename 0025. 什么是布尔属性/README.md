# [0025. 什么是布尔属性](https://github.com/Tdahuyou/react/tree/main/0025.%20%E4%BB%80%E4%B9%88%E6%98%AF%E5%B8%83%E5%B0%94%E5%B1%9E%E6%80%A7/README.md)
...
- [🤖 什么是布尔属性](#🤖-什么是布尔属性)
  - [常见的布尔属性](#常见的布尔属性)
  - [使用示例](#使用示例)
  - [在 JavaScript 中处理布尔属性](#在-javascript-中处理布尔属性)
- [🤖 布尔属性名称的由来](#🤖-布尔属性名称的由来)
- [🤖 请介绍一下 React 中组件的布尔属性](#🤖-请介绍一下-react-中组件的布尔属性)
  - [布尔属性在 React 中的应用](#布尔属性在-react-中的应用)
    - [1. 简单示例](#1-简单示例)
    - [2. 使用条件渲染](#2-使用条件渲染)
    - [3. 自定义组件中的布尔属性](#3-自定义组件中的布尔属性)
  - [注意事项](#注意事项)
<!-- endregion:toc -->
